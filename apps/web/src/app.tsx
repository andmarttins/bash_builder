...
export function App(): React.JSX.Element {
  ...
  if (mode === 'signed-in' && identity) return <main className="shell"><section className="panel dashboard dashboard-wide" aria-labelledby="dashboard-title">
    ...
    </> : workspaceView === 'events' ? <EventsModulePage canManage={identity.membership.role === 'OWNER' || identity.membership.role === 'ADMIN'} /> : workspaceView === 'tv' ? <TvModulePage canManage={identity.membership.role === 'OWNER' || identity.membership.role === 'ADMIN'} /> : <OperationalModulePage view={workspaceView} canManage={identity.membership.role === 'OWNER' || identity.membership.role === 'ADMIN'} />}
