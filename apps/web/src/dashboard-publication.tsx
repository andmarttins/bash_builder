...
type Dashboard = { id: string; title: string; description: string | null; widgets: Array<{ type: string; title: string; config: Record<string, unknown> }>; published: boolean; version: number; publicExpiresAt?: string | null; publicRevokedAt?: string | null };
...
type AnalyticsSummary = { safety: { open: number; inReview: number }; changes: Array<{ status: string; total: number }>; bash: Array<{ stage: string; total: number }>; hht: { year: number; month: number; rates: Record<string, unknown> } | null };
