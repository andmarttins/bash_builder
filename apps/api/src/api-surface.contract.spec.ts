...
const internalRoutes: RouteContract[] = [
  ...
  ,{ method: 'PATCH', url: '/v1/classifications/a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14', payload: {}, expectedStatus: 200 }
  ...
  ,{ method: 'PUT', url: '/v1/hht/reference-targets', payload: {}, expectedStatus: 200 }
  ,{ method: 'POST', url: '/v1/hht/late-exceptions', payload: {}, expectedStatus: 201 }
  ,{ method: 'POST', url: '/v1/hht/late-exceptions/a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14/revoke', payload: {}, expectedStatus: 201 }
  ...
  ,{ method: 'GET', url: '/v1/operations/webhooks/dead-letter', expectedStatus: 200 }
  ,{ method: 'GET', url: '/v1/operations/audit', expectedStatus: 200 }
  ...
  ,{ method: 'POST', url: '/v1/operations/webhooks/dead-letter/a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14/redrive', payload: {}, expectedStatus: 201 }
...
describe('internal API surface contract', () => {
  ...
  beforeAll(async () => {
    ...
    const operations = {
      listClassifications: vi.fn().mockResolvedValue([]), createClassification: vi.fn().mockResolvedValue({}), updateClassification: vi.fn().mockResolvedValue({}), listEvents: vi.fn().mockResolvedValue([]), createEvent: vi.fn().mockResolvedValue({}), addEventAction: vi.fn().mockResolvedValue({}), addEventAttachment: vi.fn().mockResolvedValue({}), openEventAttachmentDownload: vi.fn().mockResolvedValue({ body: Buffer.from(''), contentType: 'application/octet-stream', filename: 'file' }), completeEventAction: vi.fn().mockResolvedValue({}), transitionEvent: vi.fn().mockResolvedValue({}),
