...
describe('internal API surface contract', () => {
  ...
  beforeAll(async () => {
    ...
    const operations = {
      ...
      listHht: vi.fn().mockResolvedValue({ companies: [], reports: [], windows: [], publications: [], targets: [] }), createHhtCompany: vi.fn().mockResolvedValue({}), upsertHhtReport: vi.fn().mockResolvedValue({}), setHhtReportStatus: vi.fn().mockResolvedValue({}), upsertHhtWindow: vi.fn().mockResolvedValue({}), upsertHhtReferenceTarget: vi.fn().mockResolvedValue({}), closeHhtWindow: vi.fn().mockResolvedValue({}), publishHhtPeriod: vi.fn().mockResolvedValue({}),
